...
from .pop_screenprint import PopCoastalPipeline, PopRebelPipeline
from .pop_coastal_poster import PopCoastalPosterPipeline
...
PIPELINE_MAP = {
    'pop-coastal': PopCoastalPipeline,
    'pop-coastal-poster': PopCoastalPosterPipeline,
    'pop-rebel': PopRebelPipeline,
...
def process_render(
    ...
    try:
        ...
        try:
            ...
            source_image = ImageOps.exif_transpose(Image.open(input_path))
